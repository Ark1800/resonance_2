...
impl ProgressBar {
    ...
    pub fn update(&mut self) {
        if self.animate && self.current_value != self.target_value {
            ...
            if diff.abs() > 0.001 {
                ...
                if (step > 0.0 && self.current_value > self.target_value) || (step < 0.0 && self.current_value < self.target_value) {
    ...
    pub fn draw(&mut self) {
        ...
        if self.border {
            // Draw border
            draw_rectangle_lines(self.x, self.y, self.width, self.height, self.border_thickness, self.border_color);
        ...
        match self.orientation {
            ProgressBarOrientation::Horizontal => {
                ...
                draw_rectangle(self.x + inset, self.y + inset, fill_width, available_height, self.fill_color);
            }
        ...
        if !display_text.is_empty() {
            ...
            draw_text(&display_text, text_x, text_y, font_size as f32, self.text_color);
        }
    }
}
