...
pub struct DatabaseTable {
    ...
    pub player_clearedvar: i32,
    pub player_currentscreenvar: String,
    pub player_x: f64,
    pub player_y: f64,
    pub musicoins: i32,
    pub inv_1: i32,
...
impl DatabaseClient {
    ...
    #[allow(unused)]
    pub async fn update_record_by_struct(&self, table: &str, record: &DatabaseTable) -> Result<i64, Box<dyn std::error::Error>> {
        ...
        let sql = format!("UPDATE {} SET {} WHERE id = {}", table, set_clause.join(", "), record.id);
