...
impl MessageBox {
    ...
    // Customize colors
    #[allow(unused)]
    pub fn with_colors(&mut self, title_bg: Color, dialog_bg: Color, title_text: Color, message_text: Color, modal_overlay: Color) -> &mut Self {
    ...
    #[allow(unused)]
    pub fn with_button_colors(&mut self, button_bg: Color, button_hover: Color, button_text: Color) -> &mut Self {
    ...
    pub fn update_and_draw(&mut self) -> Option<MessageBoxResult> {
        ...
        if self.modal {
            ...
            let mouse_in_dialog = self.is_mouse_over_rect(self.x, self.y, self.width, self.height);
        ...
        // Draw title bar
        draw_rectangle(self.x, self.y, self.width, self.title_height, self.title_bg_color);
        ...
        if self.show_close_button {
            ...
            let is_over_close = self.is_mouse_over_rect(close_x, close_y, self.close_button_size, self.close_button_size);
        ...
        if num_buttons > 0 {
            ...
            for i in 0..num_buttons {
                ...
                let is_over_button = self.is_mouse_over_rect(button_x, button_y, button_width, self.button_height);
                ...
                button_details.push((i, self.buttons[i].clone(), button_x, button_y, button_width, is_over_button));
            }
    ...
    fn handle_dragging(&mut self) {
        ...
        let in_title_bar = self.is_mouse_over_rect(self.x, self.y, self.width, self.title_height);
    ...
    pub fn info(title: impl Into<String>, message: impl Into<String>) -> Self {
        let mut dialog = Self::new(title, message, vec!["OK"], Some(0), 400.0, 200.0);
        dialog.centered();
    ...
    pub fn custom(title: impl Into<String>, message: impl Into<String>, buttons: Vec<impl Into<String>>, default_button: Option<usize>) -> Self {
        ...
        let mut dialog = Self::new(title, message, buttons, default_button, width, 200.0);
        dialog.centered();
        dialog
    }
}
