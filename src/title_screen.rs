...
pub async fn run(
    ...
    let mut lbl_title = Label::new("Resonance 2", (virtual_width / 2.0) - 350.0, 200.0, 80);
    let mut lbl_team = Label::new("Made by Team Berry", (virtual_width / 2.0) - 350.0, 250.0, 50);
