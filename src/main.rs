...
async fn main() {
    ...
    "assets/item_files/armour/iron_armor.png", "assets/item_files/weapons/crossbow.png", "assets/item_files/armour/swift_sneakers.png", "assets/item_files/weapons/swift_sword.png",
