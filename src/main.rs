...
async fn main() {
    ...
    "assets/musicdisc_files/effectimages/bibimg.png", "assets/musicdisc_files/effectimages/trident.png", "assets/cyric_files/lightning.png", "assets/cyric_files/lightning_charge.png", "assets/cyric_files/meteor.png",
    ];
