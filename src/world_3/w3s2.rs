...
Date: 2026-04-14
Program Details: starting scene w3s2 with two mages, one slime, and one summoner. Cleared starts at 14, goes to 15. Leads to w3s4 on the right and w3s2 on the bottom.
*/
...
pub async fn run(
    ...
    player.set_currentscreen("w3s2".to_string());
